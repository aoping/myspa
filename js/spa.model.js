spa.model = (function () {
  ...
  var
    ...
    makeCid, clearPeopleDb,completeLogin,removePerson,chat,
    initModule
    ;
  ...
  people = (function () {
   ...
   chat = (function () {
    var _publish_listchange,
      _publish_updatechat, get_chatee, send_msg, set_chatee, chatee = null, update_avatar,person,
  ...
  initModule = function () {
    ...
    // if ( isFakeData ) {
    //   people_list = spa.fake.peopleList;
